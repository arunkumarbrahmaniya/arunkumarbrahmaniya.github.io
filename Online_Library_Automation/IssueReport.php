                ...
                <div style="width: 550px;height: 15px;text-align: justify;background-color:#ffffcc;font-size: 10px;">
                    ...
                    <table cellspacing="2" cellpadding="2" border="0" width="90%">
                       ...
                       <?php
                            ...
                            $q="SELECT isuue_mstr.issue_no,isuue_mstr.bname, book_mstr.author_name, book_mstr.pname, isuue_mstr.issue_date, isuue_mstr.return_date, isuue_mstr.book_returned FROM  onlinelibrary.isuue_mstr INNER JOIN onlinelibrary.book_mstr ON (isuue_mstr.bname = book_mstr.bname) WHERE (book_mstr.no_copy !=book_mstr.issue_copy) AND (isuue_mstr.enroll_no ='$enroll')";
	                    $r = mysql_query($q);
	                    $c = mysql_num_rows($r);
                             if ($c>0)
                             {
                        ...
                        echo "</tr>";
                                ...
                                if($r1==0){
                                    ...
                                    echo "<td align='center' width='100%' colspan='7'>";
                                        echo "No book has been issued to you !";
                                    echo "</td>";
